...
from demo_project.app.utils.log_utils import LogUtils
...
class TestLogUtils(unittest.TestCase):
    ...
    @patch('demo_project.app.utils.log_utils.LogUtils.load_logging_config')
    ...
    def test_configure_logging_exception_handling(self, mock_logging):
        ...
        self.assertEqual(
            str(context.exception),
            "log_utils::configure_logging(): ValueError - dictionary doesn\'t specify a version [Line No 49]"
        )
